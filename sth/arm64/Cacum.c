...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Cacum /Users/jimmychen/Documents/PhD/cat/sth/Cacum.mod\n");
 ...
 v=_v;
{
  ...
  cai = _ion_cai;
 { error =  integrate();
 if(error){fprintf(stderr,"at line 65 in file Cacum.mod:\n	SOLVE integrate METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } {
   }
  _ion_cai = cai;
}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/jimmychen/Documents/PhD/cat/sth/Cacum.mod";
static const char* nmodl_file_text = 
  ...
  "	RANGE buftau\n"
  "	GLOBAL con,cai0,activate_Q10,Q10,rate_k,temp1,temp2,tempb,depth\n"
  "}\n"
  "\n"
  "UNITS {\n"
  "	(mM) = (milli/liter)\n"
